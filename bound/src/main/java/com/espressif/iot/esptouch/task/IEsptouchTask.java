...
public interface IEsptouchTask {
	 ...
	 */
	IEsptouchResult executeForResult() throws RuntimeException, IOException;
	 ...
	 * @throws RuntimeException
	 */
	List<IEsptouchResult> executeForResults(int expectTaskResultCount) throws RuntimeException, IOException;
