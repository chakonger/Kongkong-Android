...
public class EsptouchGenerator implements IEsptouchGenerator {
    ...
    public EsptouchGenerator(String apSsid, String apBssid, String apPassword,
        ...
        LogUtil.log(getClass(), String.format("lexin : apSsid-%s apBssid-%s apPassword-%s apAddress-%s", apSsid, apBssid, apPassword, inetAddress.getHostAddress()));
