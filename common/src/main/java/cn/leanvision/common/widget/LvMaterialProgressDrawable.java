 ...
 * description
 ********************************/
public class LvMaterialProgressDrawable  extends Drawable implements Animatable {
    ...
    public LvMaterialProgressDrawable(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link LvMaterialProgressDrawable.LARGE} or
     *            {@link LvMaterialProgressDrawable.DEFAULT}
     */
